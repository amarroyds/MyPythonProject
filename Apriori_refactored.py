...
def frequent_itemset_1():
    ...
    for line in file:
        ...
        # increase counters if new instance of the pattern is found
        for word in words:
            # print '%s\t%s' % (word, 1)
    ...
    for keys in my_dict:
        ...
        if my_dict[keys] > MIN_SUP:
            frequent_items_1[keys] = my_dict[keys]

    return frequent_items_1
...
def main():
    ...
    frequent_items_k.update(frequent_itemset_1())
    ...
    #writing frequent itemset of size 1
    ...
    #Iterate for all frequent itemsets of size > 1
